...
contract TokenQueryContract is HederaTokenService, ExpiryHelper, KeyHelper {
    ...
    function allowancePublic(address token, address owner, address spender)
        public
    ...
    function getApprovedPublic(address token, uint256 serialNumber)
        public
    ...
    function isApprovedForAllPublic(address token, address owner, address operator)
        public
    ...
    function isFrozenPublic(address token, address account) public returns (int256 responseCode, bool frozen) {
    ...
    function getTokenCustomFeesPublic(address token)
        public
        returns (
            int64 responseCode,
    ...
    function getTokenDefaultFreezeStatusPublic(address token)
        public
    ...
    function getTokenDefaultKycStatusPublic(address token) public returns (int256 responseCode, bool defaultKycStatus) {
    ...
    function getTokenExpiryInfoPublic(address token)
        external
    ...
    function getFungibleTokenInfoPublic(address token)
        public
    ...
    function getTokenInfoPublic(address token)
        public
    ...
    function getTokenKeyPublic(address token, uint256 keyType)
        public
    ...
    function getNonFungibleTokenInfoPublic(address token, int64 serialNumber)
        public
