...
contract TokenTransferContract is HederaTokenService, ExpiryHelper, KeyHelper {
    ...
    function transferTokensPublic(address token, address[] memory accountId, int64[] memory amount)
        external
    ...
    function transferNFTPublic(address token, address sender, address receiver, int64 serialNumber)
        public
        returns (int256 responseCode)
    {
    ...
    function transferFromPublic(address token, address from, address to, uint256 amount)
        public
    ...
    function transferFromNFTPublic(address token, address from, address to, uint256 serialNumber)
        public
        returns (int64 responseCode)
    {
