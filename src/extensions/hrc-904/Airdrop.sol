...
contract Airdrop is HederaTokenService {
    ...
    function tokenAirdrop(address token, address sender, address receiver, int64 amount)
        public
        payable
    ...
    // @return responseCode The response code from the airdrop operation (22 = success)
    function nftAirdrop(address token, address sender, address receiver, int64 serial)
        public
        payable
        returns (int64 responseCode)
    {
    ...
    // @return responseCode The response code from the airdrop operation (22 = success)
    function multipleFtAirdrop(address[] memory tokens, address sender, address receiver, int64 amount)
        public
        payable
        returns (int64 responseCode)
    {
        ...
        IHederaTokenService.TokenTransferList[] memory tokenTransfers =
            new IHederaTokenService.TokenTransferList[](length);
    ...
    // @return responseCode The response code from the airdrop operation (22 = success)
    function multipleNftAirdrop(address[] memory nfts, address sender, address receiver, int64[] memory serials)
        public
        returns (int64 responseCode)
    {
    ...
    // @return responseCode The response code from the airdrop operation (22 = success)
    function tokenAirdropDistribute(address token, address sender, address[] memory receivers, int64 amount)
        public
        payable
        returns (int64 responseCode)
    {
    ...
    // @return responseCode The response code from the airdrop operation (22 = success)
    function nftAirdropDistribute(address token, address sender, address[] memory receivers, int64[] memory serials)
        public
        payable
        returns (int64 responseCode)
    {
    ...
    // @return responseCode The response code from the airdrop operation (22 = success)
    function mixedAirdrop(
        address[] memory token,
        address[] memory nft,
        address[] memory tokenSenders,
        address[] memory tokenReceivers,
        address[] memory nftSenders,
        address[] memory nftReceivers,
        int64 tokenAmount,
        ...
        IHederaTokenService.TokenTransferList[] memory tokenTransfers =
            new IHederaTokenService.TokenTransferList[](length);
        for (uint256 i = 0; i < tokenSenders.length; i++) {
            IHederaTokenService.TokenTransferList memory airdrop;
            airdrop.token = token[i];
            airdrop.transfers = createAccountTransferPair(tokenSenders[i], tokenReceivers[i], tokenAmount);
            tokenTransfers[i] = airdrop;
        }
        uint256 nftIndex = tokenSenders.length;
        for (uint256 v = 0; nftIndex < length; v++) {
            IHederaTokenService.TokenTransferList memory airdrop;
            airdrop.token = nft[v];
            IHederaTokenService.NftTransfer[] memory nftTransfers = new IHederaTokenService.NftTransfer[](1);
    ...
    function createAccountTransferPair(address sender, address receiver, int64 amount)
        internal
        pure
        returns (IHederaTokenService.AccountAmount[] memory transfers)
    {
    ...
    function prepareNftTransfer(address sender, address receiver, int64 serial)
        internal
        pure
        returns (IHederaTokenService.NftTransfer memory nftTransfer)
    {
