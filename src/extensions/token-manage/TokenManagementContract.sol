...
contract TokenManagementContract is HederaTokenService, ExpiryHelper, KeyHelper {
    ...
    function deleteTokenPublic(address token) public returns (int256 responseCode) {
    ...
    function freezeTokenPublic(address token, address account) public returns (int256 responseCode) {
    ...
    function unfreezeTokenPublic(address token, address account) public returns (int256 responseCode) {
    ...
    function pauseTokenPublic(address token) public returns (int256 responseCode) {
    ...
    function unpauseTokenPublic(address token) public returns (int256 responseCode) {
    ...
    function wipeTokenAccountPublic(address token, address account, int64 amount) public returns (int256 responseCode) {
    ...
    function wipeTokenAccountNFTPublic(address token, address account, int64[] memory serialNumbers)
        public
    ...
    function updateTokenInfoPublic(address token, IHederaTokenService.HederaToken memory tokenInfo)
        external
        returns (int256 responseCode)
    {
    ...
    function updateTokenExpiryInfoPublic(address token, IHederaTokenService.Expiry memory expiryInfo)
        external
        returns (int256 responseCode)
    {
    ...
    function burnTokenPublic(address token, int64 amount, int64[] memory serialNumbers)
        external
    ...
    function dissociateTokenPublic(address account, address token) public returns (int256 responseCode) {
    ...
    function approvePublic(address token, address spender, uint256 amount) public returns (int256 responseCode) {
    ...
    function approveNFTPublic(address token, address approved, uint256 serialNumber)
        public
        returns (int256 responseCode)
    {
    ...
    function setApprovalForAllPublic(address token, address operator, bool approved)
        public
        returns (int256 responseCode)
    {
    ...
    function updateFungibleTokenCustomFeesPublic(
        ...
        if (responseCode != HederaResponseCodes.SUCCESS) {
            revert(Strings.toString(uint256(responseCode)));
        }
    }
