...
contract AliasAccountUtility is HederaAccountService {
    ...
    function getEvmAddressAliasPublic(address accountNumAlias)
        public
    ...
    function getHederaAccountNumAliasPublic(address evmAddressAlias)
        public
    ...
    function isAuthorizedPublic(address account, bytes memory message, bytes memory signature)
        public
        returns (int64 responseCode, bool authorized)
    {
